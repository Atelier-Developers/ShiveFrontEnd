const baseUrl = "https://api.shive.atelier-team.ir/apiv1/";
...
export const CREATE_SUGGS_COMPS = baseUrl + 'issue/create/';
export const GET_SUGGS_COMPS = baseUrl + 'issue/list/';
export const UPLOAD_SUGGS_COMPS = baseUrl + 'issue/upload/';
export const CREATE_ASSIGNMENTS = baseUrl + 'assignment/create/';
export const UPLOAD_ASSIGNMENTS = baseUrl + 'assignment/upload/';
export const GET_ASSIGNMENT_SUBJECTS = baseUrl + 'assignment/subjects/all/';
export const GET_ASSIGNMENTS = baseUrl + 'assignment/subjects/';